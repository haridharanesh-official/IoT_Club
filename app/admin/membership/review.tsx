...
type Application = { id: string; registrationId: string; status: string; submittedAt: string; reason: string; name?: string | null; email?: string | null }
