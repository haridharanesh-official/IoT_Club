...
export function mapApplicationToSheetRow(
  ...
  return [
    ...
    studentProfile.college_email || (profile.email.toLowerCase().endsWith('@siet.ac.in') ? profile.email : ''),
    studentProfile.personal_email || (!profile.email.toLowerCase().endsWith('@siet.ac.in') ? profile.email : ''),
